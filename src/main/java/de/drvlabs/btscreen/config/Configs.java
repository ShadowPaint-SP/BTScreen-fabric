...
public class Configs implements IConfigHandler {
    ...
    public static class Lists {
        ...
        public static final ConfigStringList CLEAR_AREA_BLOCKS_TO_DISALLOW_BREAKING = new ConfigStringList(
                "clearAreaBlocksToDisallowBreaking", PresetMode.CLEAR_AREA_BLOCKS_TO_DISALLOW_BREAKING);
        public static final ConfigStringList CLEAR_AREA_BLOCKS_TO_IGNORE = new ConfigStringList("clearAreaBlocksToIgnore",
                PresetMode.CLEAR_AREA_BLOCKS_TO_IGNORE);
        public static final ConfigStringList FARM_BLOCKS_TO_DISALLOW_BREAKING = new ConfigStringList(
                "farmBlocksToDisallowBreaking", PresetMode.CLEAR_AREA_BLOCKS_TO_DISALLOW_BREAKING);
        public static final ConfigStringList FARM_BLOCKS_TO_IGNORE = new ConfigStringList("farmBlocksToIgnore",
                PresetMode.FARMING_BLOCKS_TO_IGNORE);
        public static final ConfigStringList ACCEPTABLE_THROWAWAY_ITEMS = new ConfigStringList(
                "acceptableThrowawayItems", PresetMode.CLEAR_AREA_ACCEPTABLE_THROWAWAY_ITEMS);
        ...
        public static final ImmutableList<IConfigBase> OPTIONS = ImmutableList.of(
                ...
                CLEAR_AREA_BLOCKS_TO_DISALLOW_BREAKING,
                CLEAR_AREA_BLOCKS_TO_IGNORE,
