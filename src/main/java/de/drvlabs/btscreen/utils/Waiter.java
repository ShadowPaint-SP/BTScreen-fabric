...
public final class Waiter {
    private final Consumer<Waiter> callback;
    private int waitTicks = 0;

    Waiter(Consumer<Waiter> callback) {
    ...
    public void start(int waitTicks) {
        ...
        if (!isCompleted() && !activeWaiter.contains(this)) {
     ...
     */
    public static Waiter wait(int ticks, Consumer<Waiter> callback) {
